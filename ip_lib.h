 ...
 * */
ip_mat * ip_mat_create(unsigned int h, unsigned int w,unsigned  int k, float v);    /*implementata*/

/* Libera la memoria (data, stat e la struttura) */
void ip_mat_free(ip_mat *a);    /*implementata*/
/* Restituisce il valore in posizione i,j,k */
float get_val(ip_mat * a, unsigned int i,unsigned int j,unsigned int k);    /*implementata*/
/* Setta il valore in posizione i,j,k a v*/
void set_val(ip_mat * a, unsigned int i,unsigned int j,unsigned int k, float v);    /*implementata*/
/* Calcola il valore minimo, il massimo e la media per ogni canale
 * e li salva dentro la struttura ip_mat stats
 * */
void compute_stats(ip_mat * t); /*implementata*/
/* Inizializza una ip_mat con dimensioni w h e k.
 * Ogni elemento è generato da una gaussiana con media mean e varianza var */
void ip_mat_init_random(ip_mat * t, float mean, float var); /*implementato*/
/* Crea una copia di una ip_mat e lo restituisce in output */
ip_mat * ip_mat_copy(ip_mat * in); /*implementata*/
 ...
 *      out.k = a.k + b.k
 * */
ip_mat * ip_mat_concat(ip_mat * a, ip_mat * b, int dimensione); /*implementata*/
/**** PARTE 1: OPERAZIONI MATEMATICHE FRA IP_MAT ****/
/* Esegue la somma di due ip_mat (tutte le dimensioni devono essere identiche)
 * e la restituisce in output. */
ip_mat * ip_mat_sum(ip_mat * a, ip_mat * b); /*implementata*/
/* Esegue la sottrazione di due ip_mat (tutte le dimensioni devono essere identiche)
 * e la restituisce in output.
 * */
ip_mat * ip_mat_sub(ip_mat * a, ip_mat * b); /*implementata*/
...
ip_mat * ip_mat_mul_scalar(ip_mat *a, float c); /*implementata*/
/* Aggiunge ad un ip_mat uno scalare c e lo restituisce in un nuovo tensore in output. */
ip_mat *  ip_mat_add_scalar(ip_mat *a, float c);    /*implementata*/
/* Calcola la media di due ip_mat a e b e la restituisce in output.*/
ip_mat * ip_mat_mean(ip_mat * a, ip_mat * b); /*implementata*/
 ...
 * */
ip_mat * ip_mat_to_gray_scale(ip_mat * in); /*implementata*/
...
ip_mat * ip_mat_brighten(ip_mat * a, float bright); /*implementata*/
 ...
 * */
ip_mat * ip_mat_corrupt(ip_mat * a, float amount);  /*implementata*/
/**** PARTE 3: CONVOLUZIONE E FILTRI *****/

/* Effettua la convoluzione di un ip_mat "a" con un ip_mat "f".
 * La funzione restituisce un ip_mat delle stesse dimensioni di "a".
 * */
ip_mat * ip_mat_convolve(ip_mat * a, ip_mat * f);   /*implementata*/
 ...
 * */
void rescale(ip_mat * t, float new_max);    /*implementata*/

/* Nell'operazione di clamping i valori <low si convertono in low e i valori >high in high.*/
void clamp(ip_mat * t, float low, float high);  /*implementata*/
